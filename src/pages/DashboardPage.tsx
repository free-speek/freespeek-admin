                   ...
                   <div className="ml-3">
                     ...
                     <div className="mt-2 text-sm text-blue-700">
                       <p>
                         ...
                         Users are marked as online when they send heartbeats from the mobile app.
                       </p>
                       <p className="mt-1">
                         <strong>Mobile App Integration Required:</strong> The mobile app needs to send periodic heartbeats to track online status.
                       </p>
                     </div>
                   </div>
                 </div>
